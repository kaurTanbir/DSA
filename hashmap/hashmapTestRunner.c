...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_get_NULL_when_key_is_not_present");
	setup();
		test_get_NULL_when_key_is_not_present();
	tearDown();
	testEnded();
	testStarted("test_get_NULL_when_map_is_null");
	setup();
		test_get_NULL_when_map_is_null();
	tearDown();
	testEnded();
	testStarted("test_getHashValue_gives_NULL_when_key_is_null");
	setup();
		test_getHashValue_gives_NULL_when_key_is_null();
	tearDown();
	testEnded();
