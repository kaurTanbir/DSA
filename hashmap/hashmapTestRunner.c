...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_adding_when_hash_map_is_null_should_fail");
	setup();
		test_adding_when_hash_map_is_null_should_fail();
	tearDown();
	testEnded();
	testStarted("test_adding_when_key_is_null_should_fail");
	setup();
		test_adding_when_key_is_null_should_fail();
	tearDown();
	testEnded();
