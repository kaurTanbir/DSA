...
int main(){
	...
	tearDown();
	testEnded();
	testStarted("test_returns_0_if_trying_to_Penqueue_in_a_full_queue");
	setup();
		test_returns_0_if_trying_to_Penqueue_in_a_full_queue();
	tearDown();
	testEnded();
	testStarted("test_returns_1_if_Penqueued_in_the_stack");
	setup();
		test_returns_1_if_Penqueued_in_the_stack();
	tearDown();
	testEnded();
