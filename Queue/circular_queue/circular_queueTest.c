...
//---------------------enqueue----------------------------------------
void test_5_inserts_an_Integer_element_in_queue(){
        int int_arr[3] = {1,2,0};
        int first = 1,
        	second = 2;
...
void test_6_inserts_an_double_element_in_queue(){
        int int_arr[3] = {1,2,0};
        int first = 1,
        	second = 2;
        Queue expected = {int_arr,3,sizeof(int),1,0};
...
void test_11_if_queue_is_full_returns_1(){
	int element1 = 1,
		element2 = 2,res;
	queue = create(sizeof(int),2);
...
void test_12_if_queue_is_not_full_returns_0(){
	int element1 = 1,
		res;
	queue = create(sizeof(int),2);
	enqueue(queue, &element1);
...
void test_13_if_rear_and_front_are_coresponding_to_eachother_queue_is_full(){
	String string_arr[3] = {"tannu","tanbir",""};
    String name1 = "tannu",
		   name2 = "tanbir";
...
//----------------------------dequeue----------------------------------------
void test_14_dequeues_the_first_element_of_queue_of_integers(){
	int* res;
    int first = 1,
    	second = 2;
	queue = create(sizeof(int), 3);
...
void test_15_dequeues_the_first_element_of_queue_of_doubles(){
	float* res;
    float first = 1.0,
    	  second = 2.0;
...
void test_16_dequeues_the_first_element_of_queue_of_characters(){
	char* res;
    char first = 'a',
    	 second = 'b';
	queue = create(sizeof(char), 3);
...
void test_17_dequeues_the_first_element_of_queue_of_strings(){
	String* res;
    String name1 = "annu",
    	   name2 = "tannu";
	queue = create(sizeof(String), 3);
...
void test_18_returns_null_if_trying_to_dequeue_from_an_empty_queue(){
        queue = create(sizeof(String), 2);
        ASSERT(NULL == dequeue(queue));
}
//----------------------------queueIsEmpty----------------------------------
void test_19_if_queue_is_empty_returns_1(){
	int	res;
	queue = create(sizeof(int),2);
	res = queueIsEmpty(queue);
	ASSERT(1 == res);
}
void test_20_if_queue_is_not_empty_returns_0(){
	int element1 = 1,
		res;
	queue = create(sizeof(int),2);
	enqueue(queue, &element1);
